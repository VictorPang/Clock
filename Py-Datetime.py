...
def qp(num):
    ...
    for digit in num:
        if digit == '=' or digit == '+' or digit == '-' or digit == '&' or digit == '#' or digit == '@':
            ...
            t.forward(35)
            if digit == '=':
                t.write('年',font = ('微软雅黑Light',20,'bold'))
            elif digit == '+':
                t.write('月',font = ('微软雅黑Light',20,'bold'))
            elif digit == '-':
                t.write('日',font = ('微软雅黑Light',20,'bold'))
            elif digit == '&':
                t.write('时',font = ('微软雅黑Light',20,'bold'))
            elif digit == '#':
                t.write('分',font = ('微软雅黑Light',20,'bold'))
            elif digit == '@':
                t.write('秒',font = ('微软雅黑Light',20,'bold'))
            t.forward(50)
            t.pendown()
        else:
            for i in range(7):
